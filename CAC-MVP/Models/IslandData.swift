...
struct IslandData {
    var skiesCollection = ItemCollection(items: [
        StoreItem(assetName: "skystart", level: 0, unlocked: true),
    ...
    var groundCollection = ItemCollection(items: [
        StoreItem(assetName: "groundstart", level: 0, unlocked: true),
    ...
    var pondCollection = ItemCollection(items: [
        StoreItem(assetName: "pondstart", level: 0, unlocked: true),
    ...
    var flowerCollection = ItemCollection(items: [
        StoreItem(assetName: nil, level: 0, unlocked: true),
